...
const Sidon = () => {
    ...
    const categoryImages = {
      HISTORICAL: "url('https://www.lebanoninapicture.com/Prv/Images/Pages/Page_1/Sea-Castle-Sidon-Lebanon-1.jpg')",
      ...
      COFFEE_SHOPS: "url('https://alkhabaragency.com/khbr-82148/130197771_1031711683969543_3261871058427221949_o')",
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-start">
          ...
          <p className="text-gray-800 font-semibold text-lg sm:text-xl md:text-2xl leading-relaxed max-w-4xl mx-auto" style={{ fontFamily: "'Abel', sans-serif" }}>
              Sidon, one of Lebanon's oldest cities, is a treasure trove of history and culture. Known for its ancient sea castle,
              bustling souks, and rich archaeological sites, Sidon offers visitors a unique glimpse into Lebanon's past. The city's
              vibrant markets, historic architecture, and coastal charm make it a must-visit destination. From exploring the ancient
              ruins to enjoying fresh seafood by the Mediterranean, Sidon provides an authentic Lebanese experience that combines
              historical significance with modern-day vitality.
            </p>
          </div>
          ...
          <div className="w-full max-w-5xl mt-10 p-6 flex flex-wrap justify-center gap-8">
                ...
                {selectedCategory && (
                  <div className="w-full mt-8">
                    <LocationsList city="Sidon" category={selectedCategory} />
                  </div>
                )}
        </div>
      </div>
